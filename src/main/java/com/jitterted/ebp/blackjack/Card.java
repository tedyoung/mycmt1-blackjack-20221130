...
public class Card {
    private final Suit suit; // unconstrained, logic (comparison), Card does things with other fields
    private final String rank; // String is unconstrained, behavior/logic, Card does things with suit
